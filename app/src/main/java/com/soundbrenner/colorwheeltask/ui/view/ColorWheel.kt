...
open class ColorWheel @JvmOverloads constructor(
  ...
  var thumbStrokeColor
    get() = thumbWheel.strokeColor
    set(value) {
      thumbWheel.strokeColor = value
      invalidate()
    }

  var thumbColorCircleScale
    get() = thumbWheel.colorCircleScale
    set(value) {
      thumbWheel.colorCircleScale = value
      invalidate()
    }
  ...
  private fun readThumbRadius(array: TypedArray) {
    thumbRadius = array.getDimensionPixelSize(R.styleable.ColorWheel_cw_thumbRadius, 0)
  }

  private fun readThumbColor(array: TypedArray) {
    thumbColor = array.getColor(R.styleable.ColorWheel_cw_thumbColor, 0)
  }

  private fun readStrokeColor(array: TypedArray) {
    thumbStrokeColor = array.getColor(R.styleable.ColorWheel_cw_thumbStrokeColor, 0)
  }

  private fun readColorCircleScale(array: TypedArray) {
    thumbColorCircleScale = array.getFloat(R.styleable.ColorWheel_cw_thumbColorCircleScale, 0f)
  }
